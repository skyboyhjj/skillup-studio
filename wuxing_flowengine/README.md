...
├── data/                            # 数据
│   └── snapshots/                   # 快照数据
│       ├── nodes.json               # 节点数据（AI 概念树）
│       ├── edges.json               # 边数据（概念间关系）
│       └── 2026-07-30_snapshot.json # 历史快照
├── diagnose/                        # 诊断模块
...
| 月份 | 道境阶段 | O_t | E_u | C_k | K_y | 存在度 S |
|------|----------|-----|-----|-----|-----|----------|
| 2026-07 | 克 | 0.0889 | 0.7070 | 0.0022 | 0.7511 | ~0.01 |
| 2026-08 | 克 | 0.0889 | 0.7070 | 0.0022 | 0.7511 | ~0.01 |
