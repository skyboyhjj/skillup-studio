...
# New data from browser extraction
new_data = {
    "具身智能与机器人": [
        ...
        "Any2Any: Parameter-Efficient Fine-Tuning of Humanoid Loco-Manipulation Policies"
    ],
    "多模态智能": [
        ...
        "V-SPLADE: An Inference-Free Multimodal Learned Sparse Retrieval for Production-Scale Visual Document Search",
        ...
        "Editor's Choice: An Entity-Based Evaluation Framework for Abstract Image Editing"
    ],
    "智能体": [
    ...
    "计算机视觉": [
        ...
        "Domain-Specific Camera Calibration for 3D Vision Tasks"
    ],
    "交叉领域智能应用": [
...
# Remove 软件工程与编程's Chinese summary entries (not actual paper titles)
# Keep only if they are actual paper titles
may_sw = data.get("软件工程与编程", [])
# The current entries are Chinese summaries, not paper titles. We need to re-collect or mark as empty
# For now, let's keep them but note the issue

with open(existing_path, 'w', encoding='utf-8') as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

print("Updated phase3_may_paper_titles.json")
